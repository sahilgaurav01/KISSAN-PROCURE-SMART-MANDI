/**
 * =========================================================
 * FARMER: PROCUREMENT STATUS & LIFECYCLE (js/farmer/procurement-status.js)
 * 6-step lifecycle timeline & official weighment certificate
 * =========================================================
 */
...
export function renderProcurementStatus() {
  ...
  db.bookings.forEach(b => {
    const isCompleted = b.tokenNumber <= db.currentServingToken;
  ...
  renderProcurementDetail(db.bookings[db.bookings.length - 2] || db.bookings[0]);
}
