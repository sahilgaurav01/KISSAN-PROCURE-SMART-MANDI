/**
 * =========================================================
 * FARMER: PAYMENT LEDGER (js/farmer/payment-ledger.js)
 * DBT Bank Credit Ledger & Government Payout Status
 * =========================================================
 */
...
export function renderPaymentLedger() {
  ...
  (db.payments || []).forEach(p => {
    ...
    tr.innerHTML = `
      ...
      <td class="py-3 font-mono font-bold text-emerald-700">₹${Number(p.amount).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</td>
      <td class="py-3">
